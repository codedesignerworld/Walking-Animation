...
TwL.set(B,{y:10});
TwL.set(UB,{fill:'#7af',transformOrigin:'50% 100%'});//body
TwL.set(H,{transformOrigin:'-5px 0px',rotation:-10,fill:'#555',y:-1});//hand
TwL.set(F,{transformOrigin:'55% 10px',rotation:-37,fill:'#55f'});//leg
TwL.set('#H',{transformOrigin:'5px 50px',fill:'#555',scale:0.967,rotation:-5});//head
...
TwL.set('.FB',{fill:'#55f'});//leg
TwL.set('#FB',{fill:'#55f'});//leg
TwL.set('#HB',{y:-3,fill:'#555'});
function M(p1,p2){
